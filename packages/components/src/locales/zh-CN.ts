export default {
  ...
  'DDSAnnotator.smart.detection.label': '目标检测类别',
  'DDSAnnotator.smart.detection.prompt': '提示文字',
  'DDSAnnotator.smart.detection.input': '输入提示文字',
  ...
  'DDSAnnotator.smart.msg.labelRequired': '请至少输入一个检测目标',
  ...
  'DDSAnnotator.smart.tip.edgeStitchError':
    '在使用智能缝合笔刷时，为了确保得到有效的结果，请确保至少使用2个Mask对象。',
  'DDSAnnotator.smart.tip.limitJump': '请先完成/退出当前智能标注会话',

  'DDSAnnotator.seg.tool': '分割工具',
  'DDSAnnotator.seg.tool.content': '接受本次分割结果.',
  'DDSAnnotator.confirm': '确认',
  'DDSAnnotator.points.editor': '关键点属性',
  'DDSAnnotator.attribute.modal': '标签属性',
